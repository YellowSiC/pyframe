...
with ui.row().classes("grid grid-cols-2 grid-rows-2 gap-4 p-4"):
    with ui.card().classes("flex flex-col items-center justify-center bg-white rounded-2xl shadow-xl p-4 transition hover:scale-105"):
        ui.label(text="🪟 Native Capabilities with Tao").classes("text-lg font-semibold text-gray-800")
